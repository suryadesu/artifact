...
class Timeline:
    ...
    def __init__(self, stop_time=inf, formalism='ket_vector'):
        ...
        self.ent_success_count = [[0 for i in range(4)] for j in range(4)]
        self.ent_failure_count = [[0 for i in range(4)] for j in range(4)]
        self.swap_success_count = [[0 for i in range(4)] for j in range(4)]
        self.swap_failure_count = [[0 for i in range(4)] for j in range(4)]
        #self.is_13_done = False
        self.topology = None
        self.gen_exec_count = [[0 for i in range(4)] for j in range(4)]
        self.swap_exec_count = [[0 for i in range(4)] for j in range(4)]
        self.gen_threshold = 1
        self.gen_success_probability = 0.5
        self.stop_rules = False
        #self.E2ECreated = False
        self.hasSwapFailed = False
