...
class EntanglementGenerationA(EntanglementProtocol):
    ...
    def _entanglement_succeed(self):
        ...
        # print(self.own.name + " successful entanglement of memory with the node: ",self.other)
        # print(f'Time of entanglement success: {self.own.timeline.now()}')
        ...
        # print(f'execution counter: {self.execution_count}')
        ...
        # print('ent_success_count: ', self.own.timeline.ent_success_count)
    ...
    def _entanglement_fail(self):
        ...
        # print(self.own.name + " failed entanglement of memory with the node: ",self.other)
        ...
        # print('ent_failure_count: ', self.own.timeline.ent_failure_count)
