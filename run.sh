...
prism model.prism prop.props -const mu=50,tau=15,pe=0:0.1:1,pm=0.5,tgen=5,tbsm=10 -exportresults ../results/model-pgen.csv:csv -ptamethod digital
prism model.prism prop.props -const mu=50,tau=15,pe=0.5,pm=0:0.1:1,tgen=5,tbsm=10 -exportresults ../results/model-pbsm.csv:csv -ptamethod digital
